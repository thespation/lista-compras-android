...
|:---:|:---:|:---:|
| ![Lists](screenshots/13_home_listas.png) | ![New List](screenshots/12_home_nova_lista.png) | ![Side Menu](screenshots/14_menu_lateral.png) |
...
|:---:|:---:|:---:|
| ![Items](screenshots/10_lista_itens.png) | ![Sorting](screenshots/09_lista_menu_ordenacao.png) | ![Edit](screenshots/11_editar_item.png) |
...
|:---:|:---:|:---:|
| ![Annual](screenshots/08_analise_anual.png) | ![Monthly](screenshots/07_analise_mensal.png) | ![Stores](screenshots/06_analise_mercados.png) |
...
|:---:|:---:|:---:|:---:|
| ![Navigation](screenshots/05_configuracoes_navegacao.png) | ![Appearance](screenshots/04_configuracoes_aparencia.png) | ![Font](screenshots/03_configuracoes_fonte.png) | ![Data](screenshots/02_configuracoes_dados.png) |
...
| About screen |
|:---:|
| ![About](screenshots/01_sobre.png) |
